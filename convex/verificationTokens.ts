...
export async function createVerificationTokenHandler(
  ctx: MutationCtx,
  args: { phone: string },
...
export async function consumeVerificationTokenHandler(
  ctx: MutationCtx,
  args: { token: string },
...
export const createVerificationToken = mutation({
  args: { phone: v.string() },
  handler: createVerificationTokenHandler,
});

export const consumeVerificationToken = mutation({
  args: { token: v.string() },
  handler: consumeVerificationTokenHandler,
});
